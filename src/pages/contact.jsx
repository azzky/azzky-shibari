...
const Contact = () => {
  ...
  return(
  <Layout lang={lang} url="/contact" classes="contact">
    ...
    <Wrapper>
      ...
      <Column>
        <Form method="post" netlify-honeypot="bot-field" data-netlify="true" name="contact" action="/success">
          ...
          <Input type="email" name="email" id="email" inputMode={configContact.emailLabel[lang]} placeholder="Email" required aria-required="true" />
