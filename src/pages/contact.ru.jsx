        ...
        <Wrapper>
            ...
            <Column>
                ...
                <Input type="text"
                       name="name"
                       id="name"
                       placeholder={configContact.nameLabel[lang]}
                       required
                       aria-required="true" />
                <label className="visually-hidden"
                       htmlFor="email">
                    {configContact.emailLabel[lang]}
                </label>
                <Input type="email"
                       name="email"
                       id="email"
                       inputMode="email"
                       placeholder={configContact.emailLabel[lang]}
                       required
                       aria-required="true" />
                <label className="visually-hidden"
                       htmlFor="message">
                    {configContact.messageLabel[lang]}
                </label>
                <Message name="message"
                         id="message"
                         rows="10"
                         placeholder={configContact.messageLabel[lang]}
                         required
                         aria-required="true" />
                <Submit type="submit">
                    {configContact.sendbutton[lang]}
                </Submit>
                </Form>
            </Column>
        </Wrapper>
